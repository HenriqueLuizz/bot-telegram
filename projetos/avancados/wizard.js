...
precoHandler.use(ctx => ctx.reply('Apenas números são permitidos....'))
...
dataHandler.use(ctx => ctx.reply('Entre com uma data no formato de dd/MM/YYYY'))
...
const stage = new Telegraf([wizardCompra], {default: 'compra'})
bot.use(session())
